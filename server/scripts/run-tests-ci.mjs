...
try {
  const result=spawnSync(process.platform==='win32'?'pnpm.cmd':'pnpm',['exec','vitest','run','--reporter=json',`--outputFile=${report}`],{encoding:'utf8',env:{...process.env,REQUIRE_INTEGRATION_TESTS:'true'}});
