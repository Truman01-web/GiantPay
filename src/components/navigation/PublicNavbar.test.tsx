...
describe('PublicNavbar', () => {
  ...
  it('1. renders a transparent navbar at the top of the page', () => {
    renderNavbar();
  ...
  it('2. becomes translucent with backdrop-blur after scrolling beyond threshold', () => {
    renderNavbar();
    const header = screen.getByRole('banner');
    ...
    expect(header.className).toContain('border-slate-200/80');
