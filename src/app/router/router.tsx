...
export const router = createBrowserRouter([
  {
    ...
    children: [
      ...
      { path: '/developers/overview', element: <PublicFeaturePage /> },
      { path: '/developers/api-documentation', element: <PublicFeaturePage /> },
      { path: '/developers/webhooks-api', element: <PublicFeaturePage /> },
